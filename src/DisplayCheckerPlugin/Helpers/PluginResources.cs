namespace Loupedeck.DisplayCheckerPlugin
{
    using System;
    using System.IO;
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.DisplayCheckerPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.DisplayCheckerPlugin.Resources.Resource.txt`.
